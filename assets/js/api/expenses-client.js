...
MKNexus.ExpensesApi = (function () {
  ...
  // real secret. The UI only hides the Report tab from anyone who isn't
  // an Admin or an Org Chart manager (MKNexus.Access.canViewReports() in
  // modules/expenses.js) and further scopes it to that manager's own team
